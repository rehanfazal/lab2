...
void subtraction(vector< vector<int> > &A,vector< vector<int> > &B,vector< vector<int> > &C, int tam);
void Display_Matrix(vector< vector<int> > matrix, int n);
void algorithm(vector< vector<int> > A,
	vector< vector<int> > B,
...
void subtraction(vector< vector<int> > &A,
	vector< vector<int> > &B,
	vector< vector<int> > &C, int tam) {
	int i, j;
